  ...
  return <section className="py-24 bg-background">
      <Container>
        <div className="text-center mb-16 space-y-4">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto font-inter">Each story bursts to life with expressive voices, captivating music, and vivid sound effects</p>
        </div>
