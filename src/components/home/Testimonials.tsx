...
export const Testimonials = () => {
  return <section className="py-24 bg-gradient-calm">
      <Container>
        <div className="text-center mb-16 space-y-4">
          <h2 className="font-fredoka text-4xl sm:text-5xl font-bold text-background">
            Stories from our community
          </h2>
          <p className="text-xl text-background/80 max-w-2xl mx-auto font-inter">Discover how families and educators are using StoryNest to create magical moments.</p>
        </div>

        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => <Card key={index} className="border-0 shadow-soft-lg rounded-2xl bg-card hover:scale-105 transition-transform duration-300">
